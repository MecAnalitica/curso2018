...
c) Muestra que la escalera pierde contacto con la pared al caer cuando *3 Cos(do) = 3 Cos(do)*, donde *do* es el ángulo inicial entre la escalera y la pared en reposo.
